...
protected:
    ...
    static glm::vec3 computePhongShading(const glm::vec3& color, const volume::GradientVoxel& gradient, const glm::vec3& lightDirection, const glm::vec3& viewDirection, float k_a, float k_d, float k_s,float phongAlpha);
