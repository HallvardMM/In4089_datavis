...
public:
    ...
    float getSampleInterpolate(const glm::vec3& coord, float alphaValue) const;
...
protected:
    ...
    float getSampleTriCubicInterpolation(const glm::vec3& coord, float alphaValue) const;
    float biCubicInterpolate(const glm::vec2& xyCoord, int z, float alphaValue) const;
    static float cubicInterpolate(float g0, float g1, float g2, float g3, float factor, float alphaValue);
    static float weight(float x, float alphaValue);
